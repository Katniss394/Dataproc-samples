...
conf = {
    ...
    'mapred.bq.input.project.id': 'spikey-developers',
    'mapred.bq.input.dataset.id': 'spikeysales_dataset',
    'mapred.bq.input.table.id': 'salesdata',
}

# Output Parameters.
output_dataset = 'spikeysales_dataset'
output_table = 'totalcost_output'
